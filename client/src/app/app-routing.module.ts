...
const routes: Routes = [
  ...
  },
  {
    path: '', component: SiteLayoutComponent, canActivate: [AuthGuard], children: [
      ...
      {path: 'closed', component: ClosedPageComponent},
      {path: 'closed/:id', component: ClosedFormComponent},
      {path: 'categories', component: CategoriesPageComponent},
      {path: 'categories/new', component: CategoriesFormComponent},
      {path: 'categories/:id', component: CategoriesFormComponent},
      {path: 'noms', component: NomsPageComponent},
      {path: 'noms/new', component : NomsFormComponent},
      {path: 'noms/:id', component : NomsFormComponent},
      {path: 'contrs', component: ContrsPageComponent},
      {path: 'contrs/new', component: ContrsFormComponent},
      {path: 'contrs/:id', component: ContrsFormComponent},
      {path: 'start', component: StartPageComponent},
      {path: 'prihod', component: PrihodPageComponent},
      {path: 'prihod/new', component: PrihodFormComponent}
    ]
  }
]
